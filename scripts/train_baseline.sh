...
# bash scripts/train_baseline.sh baseline efficientnet,trill_distilled trill_distilled 256,512 10 mse 1e-4 1 7

# bash scripts/train_baseline.sh baseline efficientnet,trill_distilled trill_distilled 256,512 10 mse 5e-4 2 5